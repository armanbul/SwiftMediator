...
public class MediatorGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateEmptyRegistration(SourceProductionContext context)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("[global::System.CodeDom.Compiler.GeneratedCodeAttribute(\"SwiftMediator.Generator\", \"1.0.0\")]");
        ...
        diSb.AppendLine("#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member");
        diSb.AppendLine("#pragma warning disable IL2026 // RequiresUnreferencedCode: config.Apply uses reflection only when assembly scanning is configured");
        ...
        diSb.AppendLine();
        diSb.AppendLine("[global::System.CodeDom.Compiler.GeneratedCodeAttribute(\"SwiftMediator.Generator\", \"1.0.0\")]");
        diSb.AppendLine("internal static class SwiftMediatorServiceCollectionExtensions");
        diSb.AppendLine("{");
    ...
    private static string BuildDependencyInjectionClass(List<HandlerInfo> handlers, List<OpenGenericHandlerInfo> openGenericHandlers)
    {
        ...
        sb.AppendLine("#nullable enable");
        sb.AppendLine("#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member");
        sb.AppendLine("#pragma warning disable IL2026 // RequiresUnreferencedCode: config.Apply uses reflection only when assembly scanning is configured");
        sb.AppendLine("using System;");
        sb.AppendLine("using Microsoft.Extensions.DependencyInjection;");
        sb.AppendLine("using SwiftMediator.Core;");
        sb.AppendLine();
        ...
        sb.AppendLine();
        sb.AppendLine("[global::System.CodeDom.Compiler.GeneratedCodeAttribute(\"SwiftMediator.Generator\", \"1.0.0\")]");
        sb.AppendLine("internal static class SwiftMediatorServiceCollectionExtensions");
        sb.AppendLine("{");
