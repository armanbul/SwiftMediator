...
/// they execute in registration order. Set <see cref="RequestExceptionHandlerState{TResponse}.Handled"/>
/// to stop propagation.
/// </summary>
    ...
    where TException : Exception
{
    ...
    /// <param name="state">State object — set <see cref="RequestExceptionHandlerState{TResponse}.Handled"/> 
    /// and <see cref="RequestExceptionHandlerState{TResponse}.Response"/> to suppress the exception.</param>
...
/// Setting <see cref="RequestExceptionHandlerState{TResponse}.Handled"/> to true prevents the exception from being re-thrown.
/// </summary>
...
public class RequestExceptionHandlerState<TResponse>
{
    ...
    /// The <see cref="RequestExceptionHandlerState{TResponse}.Response"/> value will be returned to the caller instead.
    /// </summary>
